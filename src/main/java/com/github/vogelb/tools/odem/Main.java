...
public class Main {
	public static void main(String[] args) {
		...
		// Export graph as graphviz DOT file (issue "dot -Tpng -O odem-analyzer.dot" to create a png image)
		try {
		...
		List<Dependency> guiDependencies = analyser.filter("com.github.vogelb.tools.*")
		        ...
		        .getDependenciesFrom();
		CsvExporter.exportDependencies(guiDependencies, "odem-analyzer-dependencies.csv", "com.github.vogelb.tools.odem.*");
        ...
        List<Dependency> dependencies = analyser.filter("com.github.vogelb.tools.odem.model.*")
                ...
                .IgnorePackageFilter(ignorePackageFilter)
                .getDependenciesTo();
        CsvExporter.exportDependencies(dependencies, "odem-analyzer-model-dependents.csv", "com.github.vogelb.tools.odem.*");
	}
}
